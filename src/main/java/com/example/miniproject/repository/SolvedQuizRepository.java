...
//    @Query("select count (sq) from SolvedQuiz sq where sq.quiz = :quizId and sq.solved = true and sq.user.id = :id")
//    Long CntByQuizIdAndId(@Param("quizId") Long quizId, @Param("id") Long id);
